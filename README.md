...
gh auth login # Запускает процесс аутентификации в GitHub CLI

# Инициализация нового репозитория
git init # Создает новый локальный репозиторий в текущей директории

# Клонирование репозитория
git clone <url> # Клонирует удаленный репозиторий по указанному URL
...
git commit -a -m "Сообщение коммита" # Добавляет все измененные файлы и создает коммит

# Просмотр истории коммитов
git log # Показывает историю коммитов
git log --oneline # Показывает сокращенную историю коммитов
git log --graph # Показывает историю с визуализацией ветвлений
...
git switch <branch_name> # Переключается на указанную ветку (альтернатива checkout)
git switch -c <branch_name> # Создает и переключается на новую ветку (альтернатива checkout -b)
git merge <branch_name> # Вливает указанную ветку в текущую
...
git pull <remote> <branch> # Загружает изменения и вливает их в текущую ветку
...
git reset HEAD <file> # Убирает файл из индекса, но сохраняет изменения
git reset --hard # Отменяет все изменения и возвращает состояние к последнему коммиту

# Работа с тегами
git tag # Показывает список тегов
git tag <tag_name> # Создает новый тег
git push <remote> <tag_name> # Отправляет тег в удаленный репозиторий

# Сравнение изменений
git diff # Показывает изменения между рабочим каталогом и индексом
git diff --cached # Показывает изменения между индексом и последним коммитом

# Работа с stash
git stash # Временно сохраняет изменения в рабочей директории
git stash list # Показывает список сохраненных stash
...
git rebase --continue # Продолжает перебазирование после разрешения конфликтов
git rebase --abort # Отменяет перебазирование

# Работа с cherry-pick
git cherry-pick <commit_hash> # Применяет изменения из указанного коммита в текущую ветку

# Работа с log с фильтрами
git log --author="Имя" # Показывает коммиты определенного автора
